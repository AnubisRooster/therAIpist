# Graph Report - therAIpist  (2026-09-07)

## Corpus Check
- Large corpus: 230 files · ~1,874,238 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.
